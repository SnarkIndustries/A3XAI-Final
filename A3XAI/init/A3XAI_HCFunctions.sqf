...
A3XAI_updateGroupSizeAuto = compileFinal preprocessFileLineNumbers format ["%1\compile\A3XAI_headlessclient\A3XAI_updateGroupSizeAuto.sqf",A3XAI_directory];
A3XAI_updateGroupSizeManual = compileFinal preprocessFileLineNumbers format ["%1\compile\A3XAI_headlessclient\A3XAI_updateGroupSizeManual.sqf",A3XAI_directory];
