...
"A3XAI_updateGroupSizeManual_PVC" addPublicVariableEventHandler {(_this select 1) call A3XAI_updateGroupSizeManual;diag_log format ["Debug: %1",_this];};
"A3XAI_updateGroupSizeAuto_PVC" addPublicVariableEventHandler {(_this select 1) call A3XAI_updateGroupSizeAuto;diag_log format ["Debug: %1",_this];};
