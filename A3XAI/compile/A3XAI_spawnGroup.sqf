...
private ["_totalAI","_spawnPos","_unitGroup","_trigger","_attempts","_baseDist","_dummy","_unitLevel","_checkPos","_moveMode"];
...
_unitLevel = [_this,5,1] call A3XAI_param;
_moveMode = [_this,6,"LIMITED"] call A3XAI_param;
_checkPos = [_this,7,false] call A3XAI_param;
...
_unitGroup setSpeedMode _moveMode;
_unitGroup setCombatMode "YELLOW";
_unitGroup allowFleeing 0;

0 = [_unitGroup,_unitLevel] spawn A3XAI_addGroupManagerSingle;	//start group-level manager
